...
const routes = [
  {
    ...
    children: [
      ...
      { path: "/clients", component: () => import("pages/ClientsPage.vue"), title: "Клиенты", name: "Clients", meta: {role: "corners-read"} },
      ...
      { path: "/useful", component: () => import("pages/UsefulPage.vue"), title: "Полезное", name: "Useful", meta: {role: ""} },
